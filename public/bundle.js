	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          'div',
	          null,
	          React.createElement('input', { type: 'text', ref: 'locationName', placeholder: 'Enter city name' })
	        ),
	        React.createElement(
	          'div',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=241bf40749ca48d1715af428a410b66d&units=imperial';

	// http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=241bf40749ca48d1715af428a410b66d
	module.exports = {
